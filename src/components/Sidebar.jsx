...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <div
        className={`absolute top-0 h-screen w-2/3 md:hidden py-10 px-4 bg-[#181818] backdrop-blur-lg z-10 p-6md:hidden  smooth-transition ${
          mobileMenuOpen ? "left-0" : "-left-full"
        }`}
      >
        <img src={logo} alt="" className="w-full h-14 object-contain" />
        <NavLinks handleNavClick={() => setMobileMenuOpen(false)} />
      </div>
    </>
  );
};
